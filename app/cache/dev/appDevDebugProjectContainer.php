...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'atn_user_profile' => 'getAtnUserProfileService',
            'atn_user_profile.form.type' => 'getAtnUserProfile_Form_TypeService',
    ...
    /**
     * Gets the 'atn_user_profile' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \atn\UserBundle\Form\Type\ProfileFormType A atn\UserBundle\Form\Type\ProfileFormType instance.
     */
    protected function getAtnUserProfileService()
    {
        return $this->services['atn_user_profile'] = new \atn\UserBundle\Form\Type\ProfileFormType('atn\\UserBundle\\Entity\\User');
    }

    /**
     * Gets the 'atn_user_profile.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \atn\MediaBundle\Form\addImageFormType A atn\MediaBundle\Form\addImageFormType instance.
     */
    protected function getAtnUserProfile_Form_TypeService()
    {
        return $this->services['atn_user_profile.form.type'] = new \atn\MediaBundle\Form\addImageFormType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'amimal', 'user' => 'root', 'password' => 'zouhaier', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/atn/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/atn/AnimalBundle/Entity'), 2 => ($this->targetDirs[3].'/src/atn/MediaBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'atn\\UserBundle\\Entity');
        $c->addDriver($b, 'atn\\AnimalBundle\\Entity');
        $c->addDriver($b, 'atn\\MediaBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('atnUserBundle' => 'atn\\UserBundle\\Entity', 'atnAnimalBundle' => 'atn\\AnimalBundle\\Entity', 'atnMediaBundle' => 'atn\\MediaBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0fc262dd92511cd7349d7a363e9598c6c5676d894961c245acdd715e557323a5');
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'atn_user_profile', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'atn_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $p = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $n, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($n, 'fos_user_security_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        $q->setOptions(array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => false, 'default_target_path' => 'atn_user_manage_home', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('nomProjet', 'Sikou Sikou');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/atn/AnimalBundle/Resources/views'), 'atnAnimal');
        $instance->addPath(($this->targetDirs[3].'/src/atn/MainBundle/Resources/views'), 'atnMain');
        $instance->addPath(($this->targetDirs[3].'/src/atn/MediaBundle/Resources/views'), 'atnMedia');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'atnAnimalBundle' => 'atn\\AnimalBundle\\atnAnimalBundle',
                'atnMainBundle' => 'atn\\MainBundle\\atnMainBundle',
                'atnMediaBundle' => 'atn\\MediaBundle\\atnMediaBundle',
            ...
            'fos_user.profile.form.type' => 'atn_user_profile',
            ...
            'fos_user.registration.form.type' => 'atn_user_registration',
